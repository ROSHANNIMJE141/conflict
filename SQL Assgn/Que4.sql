...
CREATE TABLE employees (
  ...
  JOB_ID varchar(10) NOT NULL,  SALARY decimal(8,2) DEFAULT NULL,
  COMMISSION_PCT decimal(2,2) DEFAULT NULL,   MANAGER_ID decimal(6,0) DEFAULT NULL,
...
-- Wrong Format ('0', '0000-00-00', '0000-00-00', '', '0');
...
-- •	Write a query to get the employee ID, names (first_name, last_name), salary in ascending order ofsalary
select first_name,last_name,salary from employees order by salary desc

-- •	Display first name and join date of the employees who is either IT Programmer or Sales Man
select first_name, HIRE_DATE from employees where JOB_ID ='It_prog' and JOB_ID ='sa_man'
...
-- •	Display details of the employees where commission percentage is null and salary in the range 5000to 10000 and department is 30.
...
select e.first_name,e.email from employees e join departments d on (d.department_id = d.department_id) where d.DEPARTMENT_NAME='Execative'
